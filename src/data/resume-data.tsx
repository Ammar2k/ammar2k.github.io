...
export const RESUME_DATA = {
  ...
  summary:
    "As a Solution Analyst, I have successfully developed multiple solutions to automate repeated tasks. My recent work has been focused at developing applications using LLMs. I am a lifelong learners, always improving myself step by step. Currently, I am focusing on improving my programming skills and learning about application deployment. ",
